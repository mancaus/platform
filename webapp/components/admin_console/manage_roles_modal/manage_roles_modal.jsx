            ...
            additionalRoles = (
                <div>
                    <input
                        type='checkbox'
                        ref='postall'
                        checked={this.state.hasPostAllRole}
                    ...
                    <input
                        type='checkbox'
                        ref='postallpublic'
                        checked={this.state.hasPostAllPublicRole || this.state.hasPostAllRole}
                        disabled={this.state.hasPostAllRole}
            ...
            userAccessTokenContent = (
                <div style={{borderTop: '1px solid lightgrey'}}>
                    ...
                    <input
                        type='checkbox'
                        ref='postall'
                        checked={this.state.hasUserAccessTokenRole}
